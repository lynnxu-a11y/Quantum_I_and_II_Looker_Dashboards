view: v_quantum_combined {
  derived_table: {
    sql:
      SELECT
        measurement_ts,
        measurement_ts_local,
        dt,
        site_id,
        site_name,
        meter_id,
  ...
  measure: total_pv_generation {
    ...
    drill_fields: [site_name, meter_name, dt_date, total_pv_generation]
  }
  ...
  measure: total_bess_discharge {
    ...
    value_format_name: decimal_2
    drill_fields: [site_name, meter_name, dt_date, total_bess_discharge]
  }
  ...
  measure: total_bess_charge {
    ...
    value_format_name: decimal_2
    drill_fields: [site_name, meter_name, dt_date, total_bess_charge]
  }
  ...
  measure: peak_bess_discharge {
    ...
    description: "Highest single 5-minute interval BESS discharge reading in MWh"
    value_format_name: decimal_2
  }
  ...
  measure: estimated_net_export {
    ...
    description: "Proxy for POI: PV Generation + BESS Discharge - BESS Charge"
    value_format_name: decimal_2
  }
